...
## Emissary
For smart wallets unable to provide stable signatures, an emissary can be used to produce stable sigantures. The emissary is usually a trusted entity, meaning that once a signtaure is issued it cannot be redacted. The terminology is specific to The Compact.
