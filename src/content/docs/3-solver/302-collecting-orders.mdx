...
4. Ensure the user provides an ECDSA signature **or** they have a whitelisted [emissary](/glossary#emissary) registered **or** you register the claim on-chain before filling the claim.
